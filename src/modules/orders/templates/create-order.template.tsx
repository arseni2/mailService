          ...
          <Row className='pt-1'>
            <Column>
              <Text className='text-black text-sm leading-relaxed p-0 m-0'>
                ...
                <Link
                  href={`${process.env.FRONT_PROTOCOL}${process.env.FRONT_URL}/orders/view/${dto?.id}`}
      ...
      {dto?.products?.length > 0 && (
        <Card className='mt-4'>
          <Section>
            <Row>
              <Column>
                <Heading as='h2' className='text-black text-base font-semibold leading-relaxed p-0 m-0'>Товары в заказе</Heading>
              </Column>
            </Row>
